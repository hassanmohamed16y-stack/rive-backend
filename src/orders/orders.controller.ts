...
export class OrdersController {
  ...
  @ApiOperation({
    summary: "Create a new order (supports guest and authenticated users)",
  })
  ...
  @ApiHeader({
    ...
    required: false,
    description: "Required to access a guest order.",
  })
  @ApiOperation({
    summary:
      "Retrieve an order as its authenticated owner, an admin, or its guest access-token holder",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 404,
    description:
      "Order not found, or the requester is not its owner/admin/guest-token holder",
  })
  async findOne(
  ...
  @ApiHeader({
    name: "X-Order-Access-Token",
    required: false,
    description: "Required to cancel a guest order.",
  })
  @ApiOperation({
    summary:
      "Cancel a pending order as its authenticated owner, an admin, or its guest access-token holder",
  })
