...
- Added password change/reset, Resend email delivery, protected variant/image administration, strict query and quantity validation, ESM-safe file inspection, and external-cron reservation expiry.
