...
_Generated: 2026-08-31T10:05:34.857Z_
...
Workspace `mcp.json` _(folder: rive-backend)_

- **/workspaces/rive-backend/.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **/home/codespace/.claude.json** — _File missing_
